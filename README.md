...
```bash
# Start Python server, you can change the 8080 to any of the free port
...
4. Click the 'User forum' button in the forum section in the navbar of the home page, the website will take you to the Forum page.
5. Click the 'Quiz library' button in the Quiz section in the navbar of the home page, the website will take you to the quiz library page.
